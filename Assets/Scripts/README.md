...
- `Persist Error Discoveries` 기본 켜짐: 이 기기의 PlayerPrefs에 발견 종류만 저장합니다. 씬 이동/재실행 후에도 유지하며 보관함 슬롯을 차지하지 않습니다.
...
5. Play 종료 후 다시 실행: 기록이 유지되는지 확인합니다. 정지/재시작 시 보관함은 기존 규칙을 따릅니다.
